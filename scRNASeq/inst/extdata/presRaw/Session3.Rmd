...
```{r sec3_dropProc_cbFilt_code,engine="bash",include=TRUE,eval=F}
...
---
## Evaluate HTOs
```{r sec3_CITE_ridget,include=TRUE,eval=T}
...
* Details of the two methods can be found in the BRC training cource. Please refer to this [link](https://rockefelleruniversity.github.io/RU_RNAseq/).
...
```{r SMARTSeq_doublet,include=TRUE,eval=TRUE}
library(reticulate)
...
```{r SMARTSeq_estCC,include=TRUE,eval=TRUE,echo=FALSE}
...
#
message("cell deris or doublets")
...
```{r SMARTseq_findMark,include=TRUE,eval=TRUE}
