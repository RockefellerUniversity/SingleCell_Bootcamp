...
pred_res <- TransferData(anchorset = anchors, refdata=transfer_list$ref$class_label)
head(pred_res,2)
```
...
my_seu_merge_rpca$abm_seurat_labels <- pred_res$predicted.id
