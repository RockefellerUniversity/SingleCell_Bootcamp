...
An altearntive visualization of this is an X-Y plot comparing UMIs (nCount) and genes (nFeature).
...
- If you use other methods we advise checking the documentation, reading around, talking to us as some the implementations are not the same as in other packages.
