...
clust_dat <- data.frame(Barcode=Cells(seu_filt),cluster=meta$seurat_clusters,stringsAsFactors = FALSE)
...
write.table(clust_dat,file = "clust_dat.csv",
            sep=",",quote = FALSE,row.names = FALSE)
#
cellType_dat <- data.frame(Barcode=Cells(seu_filt),cellType=meta$cellType_byClust,stringsAsFactors = FALSE)
