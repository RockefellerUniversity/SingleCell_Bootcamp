...
- why single cell? - questions that it addresses
- cover the different technologies - laso mentio. other variations like scATAC and spatial. 
- typical workflow at a coarse level - focus on 10X
- talk about the scale of the issue - i.e rapidly evolving and many packages

## Sequencer to Counts Matrix

- CellRanger
- Alternatives i.e. alevin
mention other tools that might be speicifc to alternate technologies. But maybe not go into detail with them 
