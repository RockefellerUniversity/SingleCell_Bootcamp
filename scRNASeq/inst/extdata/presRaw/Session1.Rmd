...
![Microfluidics](imgs/10x_a.png)

---
## The 10x Genomics system  - Gel beads

![beads](./imgs/10x_bead.png)

---

## The 10x Genomics system  - Sequencing primers

![primers](./imgs/10x_sequencing.png)
...
.pull-right[
![CellRanger](imgs/CellRangerPage.png)
]
...
<div align="center">
<img src="imgs/sam1.png" alt="igv" height="200" width="450">
</div>
...
We will be looking at the web summary generated from a PBMC dataset with ~1,000 cells from a healthy human donor. The full experiment details can be found on the 10X website [here](https://www.10xgenomics.com/datasets/1-k-pbm-cs-from-a-healthy-donor-v-3-chemistry-3-standard-3-0-0).
...
.pull-right[
![](./imgs/ScaleBio_scRNA_Workflow-1-2048x635.png) 
]
...
.pull-right[
![](./imgs/Visium-gene-expression-slide-1024x390.png) 
]
...
.pull-right[
![](./imgs/Spatial-AnnotatedSCdata-Illus.png) 
]
