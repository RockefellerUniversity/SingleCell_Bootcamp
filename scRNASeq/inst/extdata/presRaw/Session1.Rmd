...
For example, ScaleBio uses sample fixaton, followed by library construction in which transcripts are sequentially barcoded using a specialized plate design. 
